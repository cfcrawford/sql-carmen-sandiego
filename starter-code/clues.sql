...
#finds percentage of italian spoken per country code
select countrycode, percentage from countrylanguage where language like '%Italian%';
#finds city name from country code
...
-- from city where name is like (first part of word)
...
select name, population from city where population between 85000 and 91000;
